...
const Modal = ({negateModal, title, deleteBlog}) => {
  ...
  <div className="modal-content">
    <button onClick={negateModal} type="button" className="close-button" data-modal-hide="popup-modal">
    ...
    <div className="modal-body">
      ...
      <button onClick={deleteCurrentBlog} type="button" className="confirm-button">
        Yes, I'm sure
      </button>
      <button onClick={negateModal} type="button" className="cancel-button">
        No, cancel
      </button>
    </div>
  </div>
